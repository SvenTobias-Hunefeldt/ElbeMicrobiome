...
mantel(MT_water.diss, PP_water_MT.diss) #p = 0.035, R=-0.2167
mantel(MT_particles.diss, PP_particles_MT.diss) #p = 0.006, R=0.1988
...
Results.df = read.csv("Mantel_IndGenes_IndPP.csv", row.names = 1)
...
Top5_MG_particles.df = Results_MG_particles.df %>% filter(Mantel_Rvalue > quantile(Mantel_Rvalue, 0.975))
...
CSP_genes_MG.ls = sort(subset(Results_MG_particles.df, PhysicochemicalParameter == "CSP_um2perL")[,2])
...
#amoAClean_CO2CH4_tbl_long = read.csv( "F:/Functional_R_analysis/amoAClean_CO2CH4_OccurrenceFiltered_CSP_MG.csv")
...
#Extract relevant genes
CSP_genes_MT.ls = sort(subset(Results_MT_particles.df, PhysicochemicalParameter == "CSP_um2perL")[,2])
...
test = subset(CSP_taxa_MT.sum, KO == "K00281")

unique(test$fulltaxa)
...
#Extract relevant genes
PTN_genes_MG.ls = sort(subset(Results_MG_particles.df, PhysicochemicalParameter == "PTN_mgperL")[,2])
...
#Extract relevant genes
PTN_genes_MT.ls = sort(subset(Results_MT_particles.df, PhysicochemicalParameter == "PTN_mgperL")[,2])
...
#amoAClean_CO2CH4_tbl_long = read.csv( "F:/Functional_R_analysis/amoAClean_CO2CH4_OccurrenceFiltered_PTN_TG.csv")
...
#Extract relevant genes
Salinity_genes_MG.ls = sort(subset(Results_MG_water.df, PhysicochemicalParameter == "Salinity_PSU")[,2])
...
test = subset(Sal_taxa.sum, KO == "K00281")
...
#Extract relevant genes
Salinity_genes_MT.ls = sort(subset(Results_MT_water.df, PhysicochemicalParameter == "Salinity_PSU")[,2])
...
#Extract relevant genes
O2_genes_MG.ls = sort(subset(Results_MG_water.df, PhysicochemicalParameter == "O2_uM")[,2])
...
test = subset(O2_taxa_MG.sum, KO == "K00281")
...
#Extract relevant genes
O2_genes_MT.ls = sort(subset(Results_MT_water.df, PhysicochemicalParameter == "O2_uM")[,2])
...
test = subset(O2_taxa_MT.sum, KO == "K00281")
...
#Extract relevant genes
dCO2_genes_MG.ls = sort(subset(Results_MG_water.df, PhysicochemicalParameter == "dCO2_uM")[,2])
...
test = subset(dCO2_taxa_MG.sum, KO == "K00281")
...
#Extract relevant genes
dCO2_genes_MT.ls = sort(subset(Results_MT_water.df, PhysicochemicalParameter == "dCO2_uM")[,2])
...
test = subset(dCO2_taxa_MT.sum, KO == "K00281")
